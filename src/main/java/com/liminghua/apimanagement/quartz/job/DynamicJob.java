package com.liminghua.apimanagement.quartz.job;

import com.liminghua.apimanagement.util.StringUtil;
...
public class DynamicJob implements Job {
     ...
     *
     * @param context context JobExecutionContext中封装有Quartz运行所需要的所有信息
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (!StringUtils.isEmpty(jarPath)) {
            ...
            //若jar包存在，ProcessBuilder命令行操作运行jar包
            if (jar.exists()) {
